  ...
  const fetchCompanyInfo = useCallback(async () => {
    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        console.warn("No company info document found in Firestore for Topbar.");
        setCompanyInfo({
      ...
      console.error("Error fetching company info for Topbar:", error);
    }
  }, []);
  ...
  const fetchWebsiteSettings = useCallback(async () => {
    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        console.warn("No website settings document found in Firestore for Topbar.");
        setWebsiteSettings({
          siteTitle: "",
          siteDescription: "",
          faceAccount: "",
      ...
      console.error("Error fetching website settings for Topbar:", error);
    } finally {
      setIsLoading(false);
    }
  }, []);
          ...
          <div className="hidden sm:flex items-center gap-3">
            {isLoading ? (
              ...
              <>
                ...
                {isValidUrl(websiteSettings?.youtubeAccount) && (
                  <a
                    href={websiteSettings.youtubeAccount}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-gray-200 transition-colors"
                    aria-label="YouTube"
